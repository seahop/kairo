        ...
        <div className="flex items-center gap-2">
          ...
          {currentBoard && (
            <button
              ...
              className="px-3 py-1.5 text-sm bg-dark-700 hover:bg-dark-600 text-white rounded-lg transition-colors border border-dark-600"
              title="Insert template into current diagram"
            >
              Templates
            </button>
          )}
